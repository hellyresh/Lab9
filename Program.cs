...
namespace Lab9_Circles
{
    ...
    class Circle
    {
        ...
        public void Run()
        {
            //рандомизация времени зарождения окружности 
            Thread.Sleep(rand.Next(time/2) * 10);
            //рандомизация скорости роста окружности - время одной итерации
            int slInt = rand.Next(1, 60);          
            
            for (int i = 0; i < time / slInt * 10 ; i++)
            {
